    ...
    <body>
          ...
          <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right">
              ...
              <li>
                ...
                <a href="#modal" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-user"> </span> Login</a>
              </li>
      ...
      <div class="container" >
        ...
        <div class="row" style="padding-top: 120px;margin-bottom: 190px;">
          ...
          <div class="col-lg-12 col-xs-12 " style="padding-top: 9px;">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 align="center"><span class="glyphicon glyphicon-info-sign"></span> Tentang Kami</h3>
              </div>

              <div class="panel-body">
                <p>Aplikasi ini dibuat untuk menyelesaikan permasalah yang ada di masyarakat khususnya perguruan tinggi , Aplikasi e-vote ii bertujuan agar pengguna dapat memilih dan melihat hasil perolehan sementara pemilihan calon ketua bem dimana saja dan kapan saja . Aplikasi ini dibuat oleh 2 (dua) mahasiswa semester V (lima) program studi D4-Teknik Informatika Politeknik Harapan Bersama Tegal , yaitu Bayu Adi Prasetiyo dan Kukuh Yulian Santoso  . <br>
                  More Info : <br>
                  085643281795 (Bayu A Prasetiyo)</p>
                </div>
              </div>
            </div>
