...
if(isset($_POST['btn-save']))
{
  ...
  if ($enc_password == $enc) {
    if ($_POST['baru'] == $_POST['konfirm_baru']) {
      ...
      header("Location: ubah_password.php?failure= " . $fail);
      }else {
        $crud->update_password($enc_baru,$_SESSION['user_id']);
        header("Location: profil.php");  
      }
    }

    else{
      $fail = " konfirmasi password baru tidak sesuai";
      header("Location: ubah_password.php?failure= " . $fail);  
    }
  }
  else{
    $fail = " password lama yang anda masukan salah";
    header("Location: ubah_password.php?failure= " . $fail);
  }
}
...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="container" >
      ...
      <div class="row" style="padding-top: 120px;margin-bottom: 100px;">
            ...
            <div class="panel panel-body panel-info" style="width: 50%">
              ...
              <form method="post">
                <div class="form-group" align="left">
                 ...
                 <input class="form-control" name="lama"  type="password" placeholder="Masukan Password lama anda.....">
               </div>
