...
if(isset($_POST['btn-save']))
{
	...
	if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
		if($ukuran < 1044070){			
			if($crud->buatcalon($ketua,$prodi_ketua,$angkatan_ketua,$wakil,$prodi_wakil,$angkatan_wakil,$visi,$misi,$slogan,$file_tmp,$nama))
			{
				...
				<div class="form-three widget-shadow">
					<form class="form-horizontal" method="post" enctype="multipart/form-data">
						<div class="form-group">
							<label for="nama" class="col-sm-2 control-label">Nama Calon Ketua</label>
							<div class="col-sm-8">
								<input type="text" class="form-control1" id="nama" name="nama_ketua" placeholder="Masukan Nama Ketua...">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea placeholder="masukan visi...." name="visi" height="20px" id="visi" class="form-control"></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<textarea placeholder="masukan misi...." name="misi" height="20px" id="misi" class="form-control"></textarea>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control1" id="slogan" name="slogan" placeholder="Masukan slogan...">
							</div>
						</div>
