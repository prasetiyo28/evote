...
if(isset($_GET['pilih_id']))
{
  ...
  $id = $_GET['pilih_id'];
  echo $id;
   if($crud->pilih($id,$_SESSION['user_id']))
  {
...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <div class="container" >
      ...
      <h1 align="center">Calon Ketua dan Wakil BEM 2017</h1>
  ...
  Terima kasih , Anda telah memilih calon Ketua dan Calon Wakil Ketua BEM Politeknik Harapan Bersama <a href="#" class="alert-link">lihat Quick Count</a>.
</div> <br><br><br><br>';
           }else{ 
                $query = "SELECT * FROM calon";       
                $crud->lihatpemilihan($query);
